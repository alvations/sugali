...
Our resulting corpus runs the full gamut of text types outlined by Abney and Bird, ranging from single-language text (Wikipedia) to parallel text (UDHR and Omniglot) to IGTs (ODIN). For 332 languages the corpus contains data from more than one source.  Table~\ref{table:corpus} gives some coverage statistics, and we describe each source in the following subsections.
...
\centering
    ...
    ODIN      				& 1,270      & 100       		& 58,556		& 39 MB		\\
    Omniglot  				& 129        & 20        		& 6,749		& 677 KB	\\
    UDHR      				& 352        & 46        		& 33,117		& 5.2 MB	\\
